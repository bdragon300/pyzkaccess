...
class ControlOperation(Enum):
    """Device control available operations. See `ControlOperation` SDK func docs"""
...
class RelayGroup(Enum):
    """Device relay group on the board.

    They can be `lock` (big relays) or `aux` (smaller relays)
    """
...
class SensorType(Enum):
    """Door sensor type. See `DoorXSensorType` parameter in SDK docs"""
...
class VerifyMode(Enum):
    """Methods for board users authentication. See `DoorXVerifyType`
...
class InOutFunRelayGroup(Enum):
    """A device relay group that was triggered -- `lock`
    (big relays) or `aux` (smaller relays)
    """
...
class ChangeIPProtocol(Enum):
    """Protocol that is used to reset the device IP address.

    It can be `udp` (UDP) or `ethernet` (raw ethernet frames)
    """
...
"""The input that triggered a log event"""
...
"""The output that a log event refers to"""
...
PULL_SDK_ERRORS: Final[Dict[int, str]] = DocDict(
    {
        ...
        -206: (
            "Start of a serial interface agent program fails and the cause generally relies in "
...
"""Errors that the SDK functions may return. See errors description in SDK"""


WSA_ERROR_CODES = DocDict(
    {
        6: (
            "WSA_INVALID_HANDLE (Specified event object handle is invalid. An application attempts to "
            "use an event object, but the specified handle is not valid)"
        ),
        8: (
            "WSA_NOT_ENOUGH_MEMORY (Insufficient memory available. An application used a Windows "
        ...
        87: (
            "WSA_INVALID_PARAMETER (One or more parameters are invalid. An application used a Windows "
        ...
        995: (
            "WSA_OPERATION_ABORTED (Overlapped operation aborted. An overlapped operation was "
            "canceled due to the closure of the socket, or the execution of the SIO_FLUSH command "
            "in WSAIoctl)"
        ),
        996: (
            "WSA_IO_INCOMPLETE (Overlapped I/O event object not in signaled state. The application "
        ...
        997: (
            "WSA_IO_PENDING (Overlapped operations will complete later.  The application has "
        ...
        10004: (
            "WSAEINTR (Interrupted function call. A blocking operation was interrupted by a call "
            "to WSACancelBlockingCall)"
        ),
        10009: ("WSAEBADF (File handle is not valid. The file handle supplied is not valid)"),
        10013: (
            "WSAEACCES (Permission denied. An attempt was made to access a socket in a way "
        ...
        10014: (
            "WSAEFAULT (Bad address. The system detected an invalid pointer address in "
        ...
        10022: (
            "WSAEINVAL (Invalid argument. Some invalid argument was supplied (for example, "
        ...
        10024: (
            "WSAEMFILE (Too many open files. Too many open sockets. Each implementation may "
            "have a maximum number of socket handles available, either globally, per process, "
            "or per thread)"
        ),
        10035: (
            "WSAEWOULDBLOCK (Resource temporarily unavailable. This error is returned from "
        ...
        10036: (
            "WSAEINPROGRESS (Operation now in progress. A blocking operation is currently "
        ...
        10037: (
            "WSAEALREADY (Operation already in progress. An operation was attempted on a "
        ...
        10038: (
            "WSAENOTSOCK (Socket operation on nonsocket. An operation was attempted on "
        ...
        10039: (
            "WSAEDESTADDRREQ (Destination address required. A required address was omitted "
            "from an operation on a socket. For example, this error is returned if sendto "
            "is called with the remote address of ADDR_ANY)"
        ),
        10040: (
            "WSAEMSGSIZE (Message too long. A message sent on a datagram socket was larger "
        ...
        10041: (
            "WSAEPROTOTYPE (Protocol wrong type for socket. A protocol was specified in the "
        ...
        10042: (
            "WSAENOPROTOOPT (Bad protocol option. An unknown, invalid or unsupported option "
            "or level was specified in a getsockopt or setsockopt call)"
        ),
        10043: (
            "WSAEPROTONOSUPPORT (Protocol not supported. The requested protocol has not been "
        ...
        10044: (
            "WSAESOCKTNOSUPPORT (Socket type not supported. The support for the specified "
        ...
        10045: (
            "WSAEOPNOTSUPP (Operation not supported. The attempted operation is not supported "
        ...
        10046: (
            "WSAEPFNOSUPPORT (Protocol family not supported. The protocol family has not been "
        ...
        10047: (
            "WSAEAFNOSUPPORT (Address family not supported by protocol family. An address "
        ...
        10048: (
            "WSAEADDRINUSE (Address already in use. Typically, only one usage of each socket "
        ...
        10049: (
            "WSAEADDRNOTAVAIL (Cannot assign requested address. The requested address is not "
        ...
        10050: (
            "WSAENETDOWN (Network is down. A socket operation encountered a dead network. "
        ...
        10051: (
            "WSAENETUNREACH (Network is unreachable. A socket operation was attempted to "
            "an unreachable network. This usually means the local software knows no route "
            "to reach the remote host)"
        ),
        10052: (
            "WSAENETRESET (Network dropped connection on reset. The connection has been "
        ...
        10053: (
            "WSAECONNABORTED (Software caused connection abort. An established connection was "
            "aborted by the software in your host computer, possibly due to a data transmission "
            "time-out or protocol error)"
        ),
        10054: (
            "WSAECONNRESET (Connection reset by peer. An existing connection was forcibly "
        ...
        10055: (
            "WSAENOBUFS (No buffer space available. An operation on a socket could not be "
            "performed because the system lacked sufficient buffer space or because a queue "
            "was full)"
        ),
        10056: (
            "WSAEISCONN (Socket is already connected. A connect request was made on an "
        ...
        10057: (
            "WSAENOTCONN (Socket is not connected. A request to send or receive data was "
        ...
        10058: (
            "WSAESHUTDOWN (Cannot send after socket shutdown. A request to send or receive "
        ...
        10060: (
            "WSAETIMEDOUT (Connection timed out. A connection attempt failed because the "
        ...
        10061: (
            "WSAECONNREFUSED (Connection refused. No connection could be made because the "
        ...
        10064: (
            "WSAEHOSTDOWN (Host is down. A socket operation failed because the destination "
        ...
        10065: (
            "WSAEHOSTUNREACH (No route to host. A socket operation was attempted to an "
            "unreachable host. See WSAENETUNREACH)"
        ),
        10066: ("WSAENOTEMPTY (Directory not empty. Cannot remove a directory that is not empty)"),
        10067: (
            "WSAEPROCLIM (Too many processes. A Windows Sockets implementation may have a "
        ...
        10091: (
            "WSASYSNOTREADY (Network subsystem is unavailable. This error is returned by "
        ...
        10092: (
            "WSAVERNOTSUPPORTED (Winsock.dll version out of range. The current Windows Sockets "
        ...
        10093: (
            "WSANOTINITIALISED (Successful WSAStartup not yet performed. Either the application "
        ...
        10101: (
            "WSAEDISCON (Graceful shutdown in progress. Returned by WSARecv and WSARecvFrom "
        ...
        10103: (
            "WSAECANCELLED (Call has been canceled. A call to the WSALookupServiceEnd function "
            "was made while this call was still processing. The call has been canceled)"
        ),
        10104: (
            "WSAEINVALIDPROCTABLE (Procedure call table is invalid. The service provider "
        ...
        10105: (
            "WSAEINVALIDPROVIDER (Service provider is invalid. The requested service provider "
        ...
        10106: (
            "WSAEPROVIDERFAILEDINIT (Service provider failed to initialize. The requested "
        ...
        10107: (
            "WSASYSCALLFAILURE (System call failure. A system call that should never fail has "
        ...
        10108: (
            "WSASERVICE_NOT_FOUND (Service not found. No such service is known. The service "
        ...
        10111: (
            "WSA_E_CANCELLED (Call was canceled. A call to the WSALookupServiceEnd function "
            "was made while this call was still processing. The call has been canceled)"
        ),
        10112: ("WSAEREFUSED (Database query was refused. A database query failed because it " "was actively refused)"),
        11001: (
            "WSAHOST_NOT_FOUND (Host not found. No such host is known. The name is not an "
        ...
        11002: (
            "WSATRY_AGAIN (Nonauthoritative host not found. This is usually a temporary error "
        ...
        11003: (
            "WSANO_RECOVERY (This is a nonrecoverable error. This indicates that some sort "
        ...
        11004: (
            "WSANO_DATA (Valid name, no data record of requested type. The requested name is "
        ...
        11011: (
            "WSA_QOS_POLICY_FAILURE (QoS policy failure. The QoS request was rejected because "
        ...
        11013: (
            "WSA_QOS_BAD_OBJECT (QoS bad object. A problem was encountered with some part "
            "of the filterspec or the provider-specific buffer in general)"
        ),
        11014: (
            "WSA_QOS_TRAFFIC_CTRL_ERROR (QoS traffic control error. An error with the "
        ...
        11016: (
            "WSA_QOS_ESERVICETYPE (QoS service type error. An invalid or unrecognized service "
            "type was found in the QoS flowspec)"
        ),
        11017: (
            "WSA_QOS_EFLOWSPEC (QoS flowspec error. An invalid or inconsistent flowspec was "
        ...
        11021: (
            "WSA_QOS_EFILTERCOUNT (Incorrect QoS filter count. An incorrect number of QoS "
            "FILTERSPECs were specified in the FLOWDESCRIPTOR)"
        ),
        11022: (
            "WSA_QOS_EOBJLENGTH (Invalid QoS object length. An object with an invalid "
            "ObjectLength field was specified in the QoS provider-specific buffer)"
        ),
        11023: (
            "WSA_QOS_EFLOWCOUNT (Incorrect QoS flow count. An incorrect number of flow "
            "descriptors was specified in the QoS structure)"
        ),
        11024: (
            "WSA_QOS_EUNKOWNPSOBJ (Unrecognized QoS object. An unrecognized object was found "
            "in the QoS provider-specific buffer)"
        ),
        11025: (
            "WSA_QOS_EPOLICYOBJ (Invalid QoS policy object. An invalid policy object was found "
            "in the QoS provider-specific buffer)"
        ),
        11026: (
            "WSA_QOS_EFLOWDESC (Invalid QoS flow descriptor. An invalid QoS flow descriptor was "
            "found in the flow descriptor list)"
        ),
        11027: (
            "WSA_QOS_EPSFLOWSPEC (Invalid QoS provider-specific flowspec. An invalid or "
            "inconsistent flowspec was found in the QoS provider-specific buffer)"
        ),
        11028: (
            "WSA_QOS_EPSFILTERSPEC (Invalid QoS provider-specific filterspec. An invalid "
            "FILTERSPEC was found in the QoS provider-specific buffer)"
        ),
        11029: (
            "WSA_QOS_ESDMODEOBJ (Invalid QoS shape discard mode object. An invalid shape discard "
            "mode object was found in the QoS provider-specific buffer)"
        ),
        11030: (
            "WSA_QOS_ESHAPERATEOBJ (Invalid QoS shaping rate object. An invalid shaping rate "
            "object was found in the QoS provider-specific buffer)"
        ),
        11031: (
            "WSA_QOS_RESERVED_PETYPE (Reserved policy QoS element type. A reserved policy "
