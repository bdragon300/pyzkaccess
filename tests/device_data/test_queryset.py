...
class ModelStub2(Model):
    table_name = "table2"
    field1 = Field("Field1", str)
    incremented_field = Field("IncField", str)
...
class TestQuerySet:
    ...
    @pytest.mark.parametrize(
        "attr,args,kwargs",
        (("where", (), {"incremented_field": 5}), ("only_fields", ("incremented_field",), {}), ("unread", (), {})),
    )
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (("incremented_field", "append_foo_field"), {ModelStub.incremented_field, ModelStub.append_foo_field}),
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ((ModelStub.append_foo_field,), {ModelStub.incremented_field, ModelStub.append_foo_field}),
    ...
    def test_only_fields__should_call_sdk_with_right_params_on_iteration_start(self):
        ...
        _ = list(self.obj.only_fields("incremented_field", "append_foo_field"))

        self.sdk.get_device_data_count.assert_called_once_with("table1")
        self.sdk.get_device_data.assert_called_once_with("table1", ["FooField", "IncField"], {}, 512, False)
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ({"incremented_field": 3, "append_foo_field": "MagicFoo"}, {"IncField": "2", "FooField": "Magic"}),
        ),
    )
    ...
    def test_where__should_return_another_empty_queryset(self):
        ...
        assert res._results_iter is None and obj._results_iter is original_iter
        assert res._buffer_size is None and obj._buffer_size is None
        assert res._only_fields == {ModelStub.incremented_field} and obj._only_fields == {ModelStub.incremented_field}
    ...
    def test_where__should_call_sdk_with_right_params_on_iteration_start(self):
        ...
        _ = list(self.obj.where(incremented_field=2, append_foo_field="MagicFoo"))
    ...
    @pytest.mark.parametrize(
        "kwargs", ({"incremented_field": 3, "unknown_field": "value1"}, {"unknown_field": "value1"})
    )
    ...
    @pytest.mark.parametrize(
        "data,expect",
        (
            ({"incremented_field": 123, "append_foo_field": "MagicFoo"}, [{"IncField": "122", "FooField": "Magic"}]),
            (
                [{"incremented_field": 123, "append_foo_field": "MagicFoo"}, {"incremented_field": 5}],
                [{"IncField": "122", "FooField": "Magic"}, {"IncField": "4", "FooField": ""}],
            ),
            (ModelStub(incremented_field=123, append_foo_field="MagicFoo"), [{"IncField": "122", "FooField": "Magic"}]),
            (
                [ModelStub(incremented_field=123, append_foo_field="MagicFoo"), ModelStub(incremented_field=5)],
                [{"IncField": "122", "FooField": "Magic"}, {"IncField": "4", "FooField": ""}],
            ),
        ),
    )
    ...
    @pytest.mark.parametrize("data", ((("incremented_field", 123), ("append_foo_field", "")), None, object(), 0))
    ...
    @pytest.mark.parametrize(
        "data", ([{"IncField": "122", "FooField": "Magic"}, {"IncField": "4", "FooField": ""}], [])
    )
    ...
    def test_bool__if_cache_is_empty__should_return_if_any_records_exist(self, raw_data, length, expect):
    ...
    def test_bool__if_cache_is_fully_filled__should_return_if_any_records_exist(self, raw_data, length, expect):
        self.obj._cache = raw_data
        self.obj._results_iter = MagicMock()
        self.obj._results_iter.__next__.side_effect = StopIteration
...
class TestQuerySetIterations:
    ...
    def test_iteration__if_table_contains_records_iterator_should_produce_model_objects(self):
        data = [{"IncField": "122", "FooField": "Magic"}, {"IncField": "4"}]
        expect = [ModelStub(incremented_field=123, append_foo_field="MagicFoo"), ModelStub(incremented_field=5)]
        self.sdk.get_device_data_count.return_value = 2
        self.sdk.get_device_data.return_value = (x for x in data)
    ...
    def test_iteration__if_cache_is_not_empty__should_retrieve_items_from_there(self):
        raw_data = [{"IncField": "122", "FooField": "Magic"}, {"IncField": "222", "FooField": "Dangerous"}]
        expect = [
    ...
    @pytest.mark.parametrize("count,expect", ((1, 256), (5, 2048), (100, 32768)))
    ...
    @pytest.mark.parametrize("item", (slice(3, 2), slice(3, 2, 2), slice(2, 2), slice(2, 2, 2)))
...
class TestQuerySetModelIterator:
    ...
    @pytest.mark.parametrize(
        "item,cache_slice",
        ((slice(None, 3), slice(None, 3)), (slice(1, 3), slice(None, 3)), (slice(1, 4, 2), slice(None, 4))),
    )
    def test_next__if_cache_is_empty_and_getting_a_slice_should_fill_only_needed_items(self, item, cache_slice):
        expect = self.data
        self.qs._cache = []
        self.qs._results_iter = iter(self.raw_data)
